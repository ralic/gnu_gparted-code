...
<br>
<ol>
  <li class="step">Boot GParted live (Version 0.6.0-6 or later is required).</li>
  <li class="step">Follow the instructions to enter X, then open a terminal.</li>
...
deb http://ftp.us.debian.org/debian/ sid main contrib non-free # Or any Debian mirror site near you.
  ...
  <li class="step">apt-get install live-helper cdebootstrap drbl clonezilla zip bzip2 rsync mkisofs</li>
